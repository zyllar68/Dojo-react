...
export const SectionComponentFieldThree = () => (
    <section className="section has-background-image2" style={{backgroundImage: "url(" + image1 + ")"}}>
      <div className="container mt-1">
        <TitleField
          nameClass='sectionTitle3'
          label='How we:{fund} is differet from a traditional REIT'/>
        <ColumnsField
          nameClass='is-centered is-gapless has-text-white pt-1'>
          <ColumnField
            nameClass='is-5 column-in-vs-left'>
            <CardField
              nameClass='bg-blue card-wefund'>
              <CardContentField>
                <TitleField
                  nameClass='sectionTitle3 pt-1'
                  label='we:{fund}'/>
                <ColumnsField
                  nameClass='is-mobile is-gapless mt-2'>
          ...
          <ColumnField
            nameClass='is-5 column-in-vs-right'>
            <CardField
              nameClass='bg-blue card-trads'>
              <CardContentField>
                <TitleField
                  nameClass='sectionTitle3'
                  label='Traditional REIT'/>
              </CardContentField>
            </CardField>
          </ColumnField>
        </ColumnsField>
        <TitleField
          nameClass='sectionTitle3 pt-1'
          label='How wefund is different from do-it-yourself RE investing'/>
      </div>
    </section>
);
